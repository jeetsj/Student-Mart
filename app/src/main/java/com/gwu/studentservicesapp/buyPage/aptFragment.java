...
import com.gwu.studentservicesapp.model.db.*;

import java.util.ArrayList;
import java.util.List;

public class aptFragment extends Fragment implements ItemAdapter.myClickListener{
    ...
    public void getData(){
        ...
        items = itemDB.getItems("Apartment");
    }
